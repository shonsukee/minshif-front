	...
	return (
		<>
			<div className="container mx-auto p-6">
				...
				<p className="mb-4">
					この利用規約（以下，「本規約」といいます。）は，minshif.com（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
				</p>
				...
				<h2 className="text-2xl font-semibold mb-4">第7条（利用制限および登録抹消）</h2>
				<p className="mb-4">
				...
				<h2 className="text-2xl font-semibold mb-4">第9条（保証の否認および免責事項）</h2>
				<p className="mb-4">
				...
				<h2 className="text-2xl font-semibold mb-4">第10条（サービス内容の変更等）</h2>
				<p className="mb-4">
					当社は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。
				</p>

				<h2 className="text-2xl font-semibold mb-4">第11条（利用規約の変更）</h2>
				<p className="mb-4">
				...
				<h2 className="text-2xl font-semibold mb-4">第12条（個人情報の取扱い）</h2>
				<p className="mb-4">
					当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。
				</p>

				<h2 className="text-2xl font-semibold mb-4">第13条（通知または連絡）</h2>
				<p className="mb-4">
					ユーザーと当社との間の通知または連絡は，当社の定める方法によって行うものとします。当社は，ユーザーから，当社が別途定める方式に従った変更届け出がない限り，現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い，これらは，発信時にユーザーへ到達したものとみなします。
				</p>

				<h2 className="text-2xl font-semibold mb-4">第14条（権利義務の譲渡の禁止）</h2>
				<p className="mb-4">
					ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
				</p>

				<h2 className="text-2xl font-semibold mb-4">第15条（準拠法・裁判管轄）</h2>
				<ol className="list-decimal pl-5 mb-4">
					<li>本規約の解釈にあたっては，日本法を準拠法とします。</li>
					<li>本サービスに関して紛争が生じた場合には，当社の本店所在地を管轄する裁判所を専属的合意管轄とします。</li>
				</ol>

				<p className="mb-4 text-right">以上</p>
			</div>
		</>
	);
}
